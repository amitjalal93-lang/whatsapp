...
const StatusPreview = ({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className="fixed  inset-0 w-full h-full bg-black bg-opcity-90 z-50 flex items-center justify-center "
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-white bg-black bg-opcity-50 rounded-full p-3 hover:bg-opcity-70 transition-all z-10 "
          >
          ...
          {currentIndex > 0 && (
            <button
              onClick={onPrev}
              className="absolute top-1/2  left-4 text-white -translate-y-1/2 bg-black bg-opcity-50 rounded-full p-3 hover:bg-opcity-70 transition "
            >
          ...
          {currentIndex < contact.statuses.length - 1 && (
            <button
              onClick={onNext}
              className="absolute top-1/2  right-4 text-white -translate-y-1/2 bg-black bg-opcity-50 rounded-full p-3 hover:bg-opcity-70 transition "
            >
          ...
          {isOwnerStatus && (
            <div className="absolute bottom-4 left-4 right-4">
              <button
                ...
                className="flex items-center justify-between w-full text-white bg-black bg-opacity-50 rounded-full p-3 hover:bg-opacity-70 transition"
              >
                <div className="flex items-center space-x-2">
              ...
              <AnimatePresence>
                {showViewers && (
                  <motion.div
                    ...
                    className="mt-2 bg-black bg-opacity-70 rounded-lg overflow-y-auto p-4"
                  >
                    {loading ? (
                      ...
                      <p className="text-white ">No Viewers Yet</p>
                    )}
                  </motion.div>
                )}
              </AnimatePresence>
