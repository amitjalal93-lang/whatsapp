        ...
        <div className="relative">
          ...
          <input
            ...
            focus:ring-green-500 ${
              theme === "dark"
                ? "bg-gray-600 text-white border-gray-700 placeholder-gray-500"
                : "bg-gray-100 text-gray-80 border-gray-200 placeholder-gray-400"
            } `}
            value={searchTerms}
            ...
            <div className="ml-3 flex-1">
              <div className="flex justify-between items-baseline">
                ...
                {contact?.conversation && (
                  <span
                    className={`text-xs ${
                      theme === "dark" ? "text-gray-400" : "text-gray-00"
                    }`}
                  >
                    {formatTimestamp(
