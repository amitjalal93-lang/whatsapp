...
import { FaCheck, FaPencilAlt, FaSmile, FaCamera } from "react-icons/fa";
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center">
              ...
              flex items-center justify-center  opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer  "
                >
                  <div className="text-white mx-auto flex flex-col justify-center items-center  text-center">
